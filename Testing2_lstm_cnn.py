...
from tensorflow.keras.layers import Bidirectional, Conv1D, MaxPooling1D, GlobalAveragePooling1D # type:ignore
...
def build_lstm_model(input_shape, forecast_horizon, num_features):
    ...
    outputs = Reshape((forecast_horizon, num_features))(x)
